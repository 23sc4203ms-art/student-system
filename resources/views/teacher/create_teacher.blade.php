...
<body>
    @include('partials.navbar', ['title' => 'Add Teacher'])
    ...
    <div class="container">
        <div class="panel">
            ...
            <form method="POST" action="{{ route('teacher.teachers.store') }}" class="ajax-submit">
                @csrf
                ...
                <div class="btn-group">
                    <button type="submit" class="btn btn-blue">Create Teacher</button>
